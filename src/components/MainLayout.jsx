    ...
    <div className={`flex h-screen w-full overflow-hidden ${isDark ? 'bg-primarycolor-900' : 'bg-gray-100'}`}>
      ...
      {showSidebar && (
        <>
          {/* Backdrop */}
          <div
            className="lg:hidden fixed inset-0 z-40 transition-opacity  bg-opacity-10"
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <div className="lg:hidden px-4 py-3 flex items-center justify-between border-b bg-white border-gray-200">
          <button
            onClick={toggleSidebar}
            className="rounded-md p-1 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 text-gray-600 hover:text-gray-900"
